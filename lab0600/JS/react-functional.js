// Этот файл демонстрирует функциональные компоненты React
// Для работы требуется установка React: npm install react react-dom
...
export { ProductList, ProductItem, useLocalStorage, useForm, ShoppingCart };
